...
READ_ONLY_DYNAMIC_TOOLS = {
    ...
    "tool_vendor_msys2_gnu_diff3",
    "tool_vendor_msys2_gnu_sdiff",
    "tool_vendor_msys2_gnu_printf",
    "tool_vendor_msys2_gnu_tr",
    "tool_vendor_msys2_gnu_uniq",
    "tool_vendor_msys2_gnu_sort",
    "tool_vendor_msys2_gnu_cut",
    "tool_vendor_msys2_gnu_dirname",
    "tool_vendor_msys2_gnu_basename",
    "tool_vendor_msys2_gnu_gawk",
    "tool_vendor_msys2_gnu_awk",
    "ns_list_dir",
    "ns_read_file",
    "ns_search_text",
    "ns_file_stat",
