...
TOOLBELT: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "tools": [
            "python tools/scripts/takesome.py validate-build",
            "python tools/scripts/takesome.py plugin-status dev",
            "python tools/scripts/takesome.py build-plugins dev",
            "python tools/scripts/takesome.py run-game dev --check-plugins-only",
        ],
    ...
    },
    {
        ...
        "risk": "writes_reports",
        "tools": [
            "python tools/scripts/takesome.py endless-stream --message <text>",
            "python tools/scripts/takesome.py endless-stream --message-file <path>",
            "python tools/scripts/takesome.py endless-stream --stdin",
        ],
