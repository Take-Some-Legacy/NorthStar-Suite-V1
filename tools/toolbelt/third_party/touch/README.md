...
Third-party GNUWin32 `touch.exe` package.

This package is self-contained: executable payload and runtime DLL dependencies live inside this package's `bin/` directory.

```text
package root: tools/toolbelt/third_party/touch
bin:          tools/toolbelt/third_party/touch/bin/
entrypoint:   tools/toolbelt/third_party/touch/bin/touch.exe
```
...
- Do not call `touch.exe` directly from reusable engine/runtime code.
