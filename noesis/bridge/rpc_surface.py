...
PUBLIC_TOOL_TITLES: Dict[str, str] = {
    ...
    "ns_list_dir": "List directory",
    "ns_read_file": "Read file",
    "ns_search_text": "Search text",
    "ns_file_stat": "Stat files",
    "ns_tree": "List tree",
    "ns_count_lines": "Count lines",
...
PUBLIC_TOOL_MAP: Dict[str, str] = {
    ...
    "ns_list_dir": "northstar.operator_fs_list_dir",
    "ns_read_file": "northstar.operator_fs_read_file",
    "ns_search_text": "northstar.operator_fs_search_text",
    "ns_file_stat": "northstar.operator_fs_file_stat",
    "ns_tree": "northstar.operator_fs_tree",
    "ns_count_lines": "northstar.operator_fs_count_lines",
...
def _public_description(public_name: str, internal: ToolSpec) -> str:
    descriptions = {
        ...
        "ns_list_dir": "Read-only bounded directory listing through the operator filesystem layer.",
        "ns_read_file": "Read-only bounded UTF-8 text file read through the operator filesystem layer.",
        "ns_search_text": "Read-only bounded text search through the operator filesystem layer.",
        "ns_file_stat": "Read-only file stat through the operator filesystem layer.",
        "ns_tree": "Read-only bounded tree listing through the operator filesystem layer.",
        "ns_count_lines": "Read-only bounded source line counter through the operator filesystem layer.",
...
def _tool_annotations(public_name: str = "") -> Dict[str, Any]:
    ...
    return {
        ...
        "destructiveHint": oauth_scopes.destructive_hint(public_name),
        "openWorldHint": False,
