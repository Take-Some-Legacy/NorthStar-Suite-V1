...
from noesis.bridge.workspace_config import apply_workspace_environment, load_workspace_config, resolve_workspace_root

DEFAULT_HOST = "127.0.0.1"
DEFAULT_PORT = 8797
SAFE_MARKERS = ("-m noesis bridge", "noesis.bridge.cli")
...
def cmd_preflight(args: argparse.Namespace) -> int:
    ...
    payload = {
        ...
        "port": args.port,
        "command": "preflight",
        "virtual_origin": "python -m noesis bridge --hello",
